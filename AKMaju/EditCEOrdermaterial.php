            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-4">Edit Electric Order</h3>
                    </div>   
                    <?php
                        echo "<div class='mb-3'>
                    ...
                    <div id="addOrderMaterialCard" class="card shadow mb-3">
                        ...
                        <div class="card-body">
                            <?php
                                echo "<form method='get' onsubmit='return validateForm()' action='save_Eeditorder.php?id=".$rows['U_id']."&co_id=$co_id'>";
                            ?>
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                    ...
                    <?php
                        echo "<div class='mb-3'>
                        <a href='EditCOrder.php?id=" . $rows['U_id'] . "&co_id=" . $co_id . "'><button class='btn btn-primary btn-sm'>< Back</button></a>
                        <a href='EditKABuruh.php?id=" . $rows['U_id'] . "&co_id=" . $co_id . "'><button class='btn btn-primary btn-sm'>Kadar Awam ></button></a>
                        </div>";
                    ?>
                </div>                
