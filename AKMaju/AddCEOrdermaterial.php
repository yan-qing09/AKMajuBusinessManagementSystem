...
$queryMT = "SELECT T_Desc FROM tb_cm_type WHERE CM_ctgy = '1'"; 
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-4">Add Electric Order Material</h3>
                    </div>   
                    <div class="card shadow mb-3">
                        ...
                        <div class="card-body">
                            <?php
                                echo "<form method='get' onsubmit='return validateForm()' action='save_Eaddorder.php?id=".$rows['U_id']."&co_id=$co_id'>";
                            ?>
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                    ...
                    <?php
                        echo "<div class='mb-3'><a href='AddKABuruh.php?id=" . $rows['U_id'] . "&co_id=" . $co_id . "'><button class='btn btn-primary btn-sm'>Add Kejuteraan Kadar ></button></a></div>";
                    ?>
                </div>                
            </div>
...
document.getElementById('Mtype').addEventListener('change', function() {
    ...
    if (selectedValue !== '') {
        ...
        fetch('get_mnames.php?mt=' + selectedValue)
