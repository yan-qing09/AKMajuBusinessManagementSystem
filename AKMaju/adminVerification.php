...
$sql_invoice = "SELECT *
                  ...
                  WHERE I_status = '11' OR I_status = '12'";
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div class="button-row">
            ...
            <div id="advertisementQuotationsTable">
                <div class="card shadow" style="margin-left: 2%;margin-right: 2%;margin-top: 2%">
                    <div class="card-header py-3">
                        <p class="text-primary m-0 fw-bold">Advertisement Quotations Awaiting Approval</p>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive table mt-2" role="grid" aria-describedby="dataTable_info">
                            <table class="table my-0 table-responsive table mt-2" id="dataTableAQA">
                                <thead>
                                    <tr>
                                        ...
                                        while ($row1 = mysqli_fetch_array($resultaq)) {
                                            ...
                                            echo "<script>
                                              document.addEventListener('DOMContentLoaded', function() {
                                                 var modalId = 'approveAQModal-" . $currentAQId . "';
                                            ...
                                            echo "<script>
                                                document.addEventListener('DOMContentLoaded', function() {
                                                    var rejectModalId = 'rejectAQModal-" . $currentAQId . "';
                                                    var rejectModalTrigger = document.getElementById('rejectModalTrigger-" . $currentAQId . "');
                                                    var rejectModal = new bootstrap.Modal(document.getElementById(rejectModalId));
                                                    
                                                    rejectModalTrigger.addEventListener('click', function() {
                                                        rejectModal.show();
                                                    });
                                                });
                                            </script>";
                                            echo "<tr>";
                                            echo "<td class='items1'>" . $row1['AQ_id'] . "</td>";
                                            echo "<td class='items2'>" . $row1['C_name'] . "</td>";
                                            ...
                                            echo "<i class='las la-check-double' style='color: white; font-size:20px'></i>";
                                            echo "</button>";
                                            echo "<button type='button' class='btn btn-danger m-1 rejectAQButton' id='rejectModalTrigger-" . $currentAQId . "' style='width: 35px; height: 35px; margin-top: -10px; display: flex; justify-content: center; align-items: center;'>
                                            ...
                                            echo "</tr>";
                                            echo "<div class='modal fade' role='dialog' tabindex='-1' id='approveAQModal-" . $currentAQId . "' style='margin: 0px;margin-top: 0px;text-align: left;'>
                                                    <div class='modal-dialog modal-lg modal-dialog-centered modal-fullscreen-lg-down' role='document'>
                                                        <div class='modal-content'>
                                                            <div class='modal-header' style='margin: 0px;'>
                                                                <h4 class='modal-title' style='color: rgb(0,0,0);'>Approve Advertisement Quotation</h4><button class='btn-close' type='button' aria-label='Close' data-bs-dismiss='modal'></button>
                                                            </div>
                                                            <div class='modal-body'>
                                                                <form id='approveAQ' method='post' action='adVerificationProcess.php?id=" . $fid . "'>
                                                                    <div class='container'>
                                                                      <p>Are you sure you want to approve this advertisement quotation?</p>
                                                                  </div>
                                                                    <div class='modal-footer'>
                                                                              <input type='hidden' name='form_type' value='AQ'>
                                                                              <input type='hidden' name='form_id' value='$currentAQId'>
                                                                              <input type='hidden' name='order_id' value='$AQAOid'>
                                            ...
                                            echo "<div class='modal fade' role='dialog' tabindex='-1' id='rejectAQModal-" . $currentAQId . "' style='margin: 0px;margin-top: 0px;text-align: left;'>
                                                  <div class='modal-dialog modal-lg modal-dialog-centered modal-fullscreen-lg-down' role='document'>
                                                      <div class='modal-content'>
                                                          <div class='modal-header' style='margin: 0px;'>
                                                              <h4 class='modal-title' style='color: rgb(0,0,0);'>Reject Advertisement Quotation</h4>
                                                              <button class='btn-close' type='button' aria-label='Close' data-bs-dismiss='modal'></button>
                                                          </div>
                                                          <div class='modal-body'>
                                                              <form id='rejectAQ' method='post' action='adminReject.php?id=" . $fid . "'>
                                                                  <div class='container'>
                                                                      <p>Are you sure you want to reject this advertisement quotation?</p>
                                                                  </div>
                                                                  <div class='modal-footer'>
                                                                      <input type='hidden' name='form_type' value='AQ'>
                                                                      <input type='hidden' name='form_id' value='$currentAQId'>
                                                                      <input type='hidden' name='order_id' value='$AQAOid'>
                                                                      <input type='hidden' name='action' value='rejectAQ'>
            ...
            <div id="constructionQuotationsTable" style="display: none;">
                <div class="card shadow" style="margin-left: 2%;margin-right: 2%;margin-top: 2%">
                    <div class="card-header py-3">
                        <p class="text-primary m-0 fw-bold">Construction Quotations Awaiting Approval</p>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive table mt-2" role="grid" aria-describedby="dataTable_info">
                            <table class="table my-0 table-responsive table mt-2" id="dataTableCQA">
                                <thead>
                                    <tr>
                                        <th style="width: 10%;">ID</th>
                                        <th style="width: 18%;">Customer</th>
                                ...
                                <tbody>
                                    <?php
                                        while ($row2 = mysqli_fetch_array($resultcq)) {
                                            $currentCQid = $row2['CQ_id'];
                                            $CQCOid = $row2['O_id'];
                                            ...
                                            echo "<script>
                                              document.addEventListener('DOMContentLoaded', function() {
                                                 var modalId1 = 'approveCQModal1-" . $currentCQid . "';
                                                 var modalTrigger1 = document.getElementById('modalTrigger1-" . $currentCQid . "');
                                                 var myModal1 = new bootstrap.Modal(document.getElementById(modalId1));
                                            ...
                                            echo "<script>
                                                document.addEventListener('DOMContentLoaded', function() {
                                                    var rejectCQModalId = 'rejectCQModal-" . $currentCQid . "';
                                                    var rejectCQModalTrigger = document.getElementById('rejectCQModalTrigger-" . $currentCQid . "');
                                                    var rejectCQModal = new bootstrap.Modal(document.getElementById(rejectCQModalId));
                                                    
                                                    rejectCQModalTrigger.addEventListener('click', function() {
                                                        rejectCQModal.show();
                                                    });
                                                });
                                            </script>";
                                            echo "<tr>";
                                            echo "<td class='items1'>" . $row2['CQ_id'] . "</td>";
                                            echo "<td class='items2'>" . $row2['C_name'] . "</td>";
                                            echo "<td class='items'>" . $row2['CQ_issueDate'] . "</td>";
                                            echo "<td class='items'>" . (isset($rowgnrcq['U_name']) ? $rowgnrcq['U_name'] : '-') . "</td>";
                                            echo "<td class='items'>" . $row2['O_desc'] . "</td>";
                                            echo "<td class='items'>
                                                      <div style='display: flex; align-items: center; justify-content: center;'>
                                                          ...
                                                          <i class='fas fa-book-open'></i></a>";
                                            echo "<button type='button' class='btn btn-success m-1' id='modalTrigger1-" . $currentCQid . "' style='width: 35px; height: 35px; margin-top: -10px; display: flex; justify-content: center; align-items: center;'>";
                                            echo "<i class='las la-check-double' style='color: white; font-size:20px'></i>";
                                            echo "</button>";
                                            echo "<button type='button' class='btn btn-danger m-1 rejectCQButton' id='rejectCQModalTrigger-" . $currentCQid . "' style='width: 35px; height: 35px; margin-top: -10px; display: flex; justify-content: center; align-items: center;'>
                                                    <i class='las la-times' style='color: white; font-size:20px'></i>
                                                </button>";
                                            echo "               
                                                </div>
                                            ...
                                            echo "</tr>";
                                            echo "<div class='modal fade' role='dialog' tabindex='-1' id='approveCQModal1-" . $currentCQid . "' style='margin: 0px;margin-top: 0px;text-align: left;'>
                                                    <div class='modal-dialog modal-lg modal-dialog-centered modal-fullscreen-lg-down' role='document'>
                                                        <div class='modal-content'>
                                                            <div class='modal-header' style='margin: 0px;'>
                                                                <h4 class='modal-title' style='color: rgb(0,0,0);'>Approve Construction Quotation</h4><button class='btn-close' type='button' aria-label='Close' data-bs-dismiss='modal'></button>
                                                            </div>
                                                            <div class='modal-body'>
                                                                <form id='approveCQ' method='post' action='adVerificationProcess.php?id=" . $fid . "'>
                                                                    <div class='container'>
                                                                      <p>Are you sure you want to approve this construction quotation?</p>
                                                                  </div>
                                                                    <div class='modal-footer'>
                                                                              <input type='hidden' name='form_type' value='CQ'>
                                                                              <input type='hidden' name='form_id' value='$currentCQid'>
                                                                              <input type='hidden' name='order_id' value='$CQCOid'>
                                                                              <input type='hidden' name='action' value='approve'>
                                                                              <button type='submit' class='btn btn-primary'>Yes</button>
                                                                              <button type='submit' class='btn btn-secondary' data-bs-dismiss='modal'>No</button>
                                                                    </div>
                                            ...
                                            echo "<div class='modal fade' role='dialog' tabindex='-1' id='rejectCQModal-" . $currentCQid . "' style='margin: 0px;margin-top: 0px;text-align: left;'>
                                                  <div class='modal-dialog modal-lg modal-dialog-centered modal-fullscreen-lg-down' role='document'>
                                                      <div class='modal-content'>
                                                          <div class='modal-header' style='margin: 0px;'>
                                                              <h4 class='modal-title' style='color: rgb(0,0,0);'>Reject Construction Quotation</h4>
                                                              <button class='btn-close' type='button' aria-label='Close' data-bs-dismiss='modal'></button>
                                                          </div>
                                                          <div class='modal-body'>
                                                              <form id='rejectCQ' method='post' action='adminReject.php?id=" . $fid . "'>
                                                                  <div class='container'>
                                                                      <p>Are you sure you want to reject this construction quotation?</p>
                                                                  </div>
                                                                  <div class='modal-footer'>
                                                                      <input type='hidden' name='form_type' value='CQ'>
                                                                      <input type='hidden' name='form_id' value='$currentCQid'>
                                                                      <input type='hidden' name='order_id' value='$CQCOid'>
                                                                      <input type='hidden' name='action' value='rejectCQ'>
                                                                      <button type='submit' class='btn btn-danger'>Yes</button>
                                                                      <button type='submit' class='btn btn-secondary' data-bs-dismiss='modal'>No</button>
                                                                  </div>
                                                              </form>
            ...
            <div id="invoicesTable" style="display: none;">
                <div class="card shadow" style="margin-left: 2%;margin-right: 2%;margin-top: 2%">
                    <div class="card-header py-3">
                                    ...
                                    <?php
                                        while ($row3 = mysqli_fetch_array($resultinvoice)) {
                                            ...
                                            echo "</td>";
                                                echo "<div class='modal fade' role='dialog' tabindex='-1' id='checkIModal-" . $currentIid . "' style='margin: 0px;margin-top: 0px;text-align: left;'>
                                                    <div class='modal-dialog modal-lg modal-dialog-centered modal-fullscreen-lg-down' role='document'>
                                                        <div class='modal-content'>
                                                            ...
                                                            <div class='modal-body'>
                                                                <form id='checkI' method='post' action='adVerificationProcess.php?id=" . $fid . "'>
                                                                    <div class='container'>
                                                ...
                                                echo "<div class='modal fade' role='dialog' tabindex='-1' id='rejectcModal-" . $currentIid . "' style='margin: 0px;margin-top: 0px;text-align: left;'>
                                                  <div class='modal-dialog modal-lg modal-dialog-centered modal-fullscreen-lg-down' role='document'>
                                                      <div class='modal-content'>
                                                          ...
                                                          <div class='modal-body'>
                                                              <form id='rejectcI' method='post' action='adminReject.php?id=" . $fid . "'>
                                                                  <div class='container'>
                                                ...
                                                echo "<script>
                                              document.addEventListener('DOMContentLoaded', function() {
                                                 var modalId4 = 'approveIModal4-" . $currentIid . "';
                                                 var modalTrigger4 = document.getElementById('modalTrigger4-" . $currentIid . "');
                                                 var myModal4 = new bootstrap.Modal(document.getElementById(modalId4));
                                                ...
                                                echo "<script>
                                                document.addEventListener('DOMContentLoaded', function() {
                                                    var rejectaModalId = 'rejectaModal-" . $currentIid . "';
                                                    var rejectaModalTrigger = document.getElementById('rejectaModalTrigger-" . $currentIid . "');
                                                    var rejectaModal = new bootstrap.Modal(document.getElementById(rejectaModalId));
                                                    
                                                    rejectaModalTrigger.addEventListener('click', function() {
                                                        rejectaModal.show();
                                                    });
                                                });
                                            </script>";

                                                echo "<button type='button' class='btn btn-success m-1' id='modalTrigger4-" . $currentIid . "' style='width: 35px; height: 35px; margin-top: -10px; display: flex; justify-content: center; align-items: center;'>";
                                                echo "<i class='las la-check-double' style='color: white; font-size:20px'></i>";
                                                echo "</button>";
                                                echo "<button type='button' class='btn btn-danger m-1' id='rejectaModalTrigger-" . $currentIid . "' style='width: 35px; height: 35px; margin-top: -10px; display: flex; justify-content: center; align-items: center;'>
                                                <i class='las la-times' style='color: white; font-size:20px'></i>
                                            </button>";
                                                echo "</div>
                                                  </td>";

                                                echo "<div class='modal fade' role='dialog' tabindex='-1' id='approveIModal4-" . $currentIid . "' style='margin: 0px;margin-top: 0px;text-align: left;'>
                                                    <div class='modal-dialog modal-lg modal-dialog-centered modal-fullscreen-lg-down' role='document'>
                                                        <div class='modal-content'>
                                                            <div class='modal-header' style='margin: 0px;'>
                                                                <h4 class='modal-title' style='color: rgb(0,0,0);'>Approve Invoice</h4><button class='btn-close' type='button' aria-label='Close' data-bs-dismiss='modal'></button>
                                                            </div>
                                                            <div class='modal-body'>
                                                                <form id='approveI' method='post' action='adVerificationProcess.php?id=" . $fid . "'>
                                                                    <div class='container'>
                                                                      <p>Are you sure you want to approve this invoice?</p>
                                                                  </div>
                                                                    <div class='modal-footer'>
                                                ...
                                                echo "<div class='modal fade' role='dialog' tabindex='-1' id='rejectaModal-" . $currentIid . "' style='margin: 0px;margin-top: 0px;text-align: left;'>
                                                  <div class='modal-dialog modal-lg modal-dialog-centered modal-fullscreen-lg-down' role='document'>
                                                      <div class='modal-content'>
                                                          <div class='modal-header' style='margin: 0px;'>
                                                              <h4 class='modal-title' style='color: rgb(0,0,0);'>Reject Invoice</h4>
                                                          ...
                                                          <div class='modal-body'>
                                                              <form id='rejectaI' method='post' action='adminReject.php?id=" . $fid . "'>
                                                                  <div class='container'>
                                                                      <p>Are you sure you want to reject this invoice?</p>
                                                                  </div>
                                                                  <div class='modal-footer'>
                                                                      ...
                                                                      <input type='hidden' name='form_id' value='$currentIid'>
                                                                      <input type='hidden' name='order_id' value='$IAOid'>
                                                                      <input type='hidden' name='action' value='rejectI'>
                                                                      <button type='submit' class='btn btn-danger'>Yes</button>
                                                                      <button type='submit' class='btn btn-secondary' data-bs-dismiss='modal'>No</button>
                                                                  </div>
                                                              </form>
            ...
            <div id="deliveryOrdersTable" style="display: none;">
                <div class="card shadow" style="margin-left: 2%;margin-right: 2%;margin-top: 2%">
                    <div class="card-header py-3">
                        <p class="text-primary m-0 fw-bold">Delivery Orders Awaiting Approval</p>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive table mt-2" role="grid" aria-describedby="dataTable_info">
                            <table class="table my-0 table-responsive table mt-2" id="dataTableDOA">
                                <thead>
                                    <tr>
                                        <th style="width: 10%;">ID</th>
                                        <th style="width: 18%;">Customer</th>
                                ...
                                <tbody>
                                    <?php
                                        while ($row4 = mysqli_fetch_array($resultdo)) {
                                            $currentDOid = $row4['DO_id'];
                                            $DOAOid = $row4['O_id'];
                                            ...
                                            echo "<script>
                                                  document.addEventListener('DOMContentLoaded', function() {
                                                      var modalId2 = 'approveDOModal-" . $currentDOid . "';
                                                      var modalTrigger2 = document.getElementById('modalTrigger-" . $currentDOid . "');
                                                      var myModal2 = new bootstrap.Modal(document.getElementById(modalId2));
                                                      modalTrigger2.addEventListener('click', function() { // Use modalTrigger2 here
                                                          myModal2.show();
                                                      });
                                                  });
                                              </script>";
                                            ...
                                            echo "<script>
                                                  document.addEventListener('DOMContentLoaded', function() {
                                                      var rejectDOModalId = 'rejectDOModal-" . $currentDOid . "';
                                                      var rejectDOModalTrigger = document.getElementById('rejectDOModalTrigger-" . $currentDOid . "');
                                                      var rejectDOModal = new bootstrap.Modal(document.getElementById(rejectDOModalId));
                                                      rejectDOModalTrigger.addEventListener('click', function() { // Use rejectDOModalTrigger here
                                                          rejectDOModal.show();
                                                      });
                                                  });
                                              </script>";
                                            ...
                                            echo "<tr>";
                                            echo "<td class='items1'>" . $row4['DO_id'] . "</td>";
                                            echo "<td class='items2'>" . $row4['C_name'] . "</td>";
                                            echo "<td class='items'>" . $row4['DO_issueDate'] . "</td>";
                                            echo "<td class='items'>" . (isset($rowgnrdo['U_name']) ? $rowgnrdo['U_name'] : '-') . "</td>";
                                            echo "<td class='items'>" . $row4['O_desc'] . "</td>";
                                            echo "<td class='items'>
                                                      <div style='display: flex; align-items: center; justify-content: center;'>
                                                          ...
                                                          <i class='fas fa-book-open'></i></a>";
                                            echo "<button type='button' class='btn btn-success m-1' id='modalTrigger-" . $currentDOid . "' style='width: 35px; height: 35px; margin-top: -10px; display: flex; justify-content: center; align-items: center;'>";
                                            echo "<i class='las la-check-double' style='color: white; font-size:20px'></i>";
                                            echo "</button>";
                                            echo "<button type='button' class='btn btn-danger m-1' id='rejectDOModalTrigger-" . $currentDOid . "' style='width: 35px; height: 35px; margin-top: -10px; display: flex; justify-content: center; align-items: center;'>
                                                  <i class='las la-times' style='color: white; font-size:20px'></i>
                                              </button>";
                                            ...
                                            echo "</tr>";
                                            echo "<div class='modal fade' role='dialog' tabindex='-1' id='approveDOModal-" . $currentDOid . "' style='margin: 0px;margin-top: 0px;text-align: left;'>
                                                    <div class='modal-dialog modal-lg modal-dialog-centered modal-fullscreen-lg-down' role='document'>
                                                        <div class='modal-content'>
                                                            <div class='modal-header' style='margin: 0px;'>
                                                                <h4 class='modal-title' style='color: rgb(0,0,0);'>Approve Delivery Order</h4><button class='btn-close' type='button' aria-label='Close' data-bs-dismiss='modal'></button>
                                                            </div>
                                                            <div class='modal-body'>
                                                                <form id='approveDO' method='post' action='adVerificationProcess.php?id=" . $fid . "'>
                                                                    <div class='container'>
                                                                      <p>Are you sure you want to approve this delivery order?</p>
                                                                  </div>
                                                                    <div class='modal-footer'>
                                                                              <input type='hidden' name='form_type' value='DO'>
                                                                              <input type='hidden' name='form_id' value='$currentDOid'>
                                                                              <input type='hidden' name='order_id' value='$DOAOid'>
                                                                              <input type='hidden' name='action' value='approve'>
                                                                              <button type='submit' class='btn btn-primary'>Yes</button>
                                                                              <button type='submit' class='btn btn-secondary' data-bs-dismiss='modal'>No</button>
                                                                    </div>
                                            ...
                                            echo "<div class='modal fade' role='dialog' tabindex='-1' id='rejectDOModal-" . $currentDOid . "' style='margin: 0px;margin-top: 0px;text-align: left;'>
                                                <div class='modal-dialog modal-lg modal-dialog-centered modal-fullscreen-lg-down' role='document'>
                                                    <div class='modal-content'>
                                                        <div class='modal-header' style='margin: 0px;'>
                                                            <h4 class='modal-title' style='color: rgb(0,0,0);'>Reject Delivery Order</h4>
                                                            <button class='btn-close' type='button' aria-label='Close' data-bs-dismiss='modal'></button>
                                                        </div>
                                                        <div class='modal-body'>
                                                            <form id='rejectDO' method='post' action='adminReject.php?id=" . $fid . "'>
                                                                <div class='container'>
                                                                    <p>Are you sure you want to reject this delivery order?</p>
                                                                </div>
                                                                <div class='modal-footer'>
                                                                    <input type='hidden' name='form_type' value='DO'>
                                                                    <input type='hidden' name='form_id' value='$currentDOid'>
                                                                    <input type='hidden' name='order_id' value='$DOAOid'>
                                                                    <input type='hidden' name='action' value='rejectDO'>
                                                                    <button type='submit' class='btn btn-danger'>Yes</button>
                                                                    <button type='submit' class='btn btn-secondary' data-bs-dismiss='modal'>No</button>
                                                                </div>
                                                            </form>
