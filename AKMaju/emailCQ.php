...
$query = "SELECT CQ_path, O_id 
          FROM tb_construction_quotation 
          WHERE CQ_id = '$cqId'";
$result = mysqli_query($con, $query);

    if ($result && $row = mysqli_fetch_assoc($result)) {
        $attachmentPath = 'C:/xampp/htdocs/AKMaju/AKMaju/' . $row['CQ_path'];
        ...
        $mail->Subject = "Construction Quotation";   // email subject headings
...
header("Location: save_CEditorder.php?id=$fid&co_id=$quotation");
