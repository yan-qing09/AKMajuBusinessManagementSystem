                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-3">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Edit Order Material</p>
                        </div>
                        <div class="card-body">
                            <?php
                                echo "<form method='get' onsubmit='return validateForm()' action='save_editmarkup.php?id=".$rows['U_id']."&co_id=$co_id'>";
                            ?>
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        <label class="form-label" for="OMarkup"><strong>Order Markup</strong></label>
                                        <input class="form-control" type="text" id="OMarkup" placeholder="Profit (%)" name="OMarkup" value='<?php echo $row6['CO_markup']; ?>'>
                    ...
                    <?php
                        echo "<div class='mb-3'>
                        <a href='EditKAOrdermaterial.php?id=" . $rows['U_id'] . "&co_id=" . $co_id . "'><button class='btn btn-primary btn-sm'>< Back</button></a>
                        </div>";
                    ?>
                </div>
            </div>
