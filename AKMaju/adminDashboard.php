            ...
            <div class="container">
                ...
                <div class="col">
                    <div class="card" style="padding: 20px;">
                        <?php
                        echo "<form method='post' id='filterForm' action='adminDashboard-2.php?id=" . $rows['U_id'] . "'>"
                        ?>
                        <div class="row">
                            <div class="col">
                            ...
                            <div class="col-lg-5 col-xxl-6 mb-4">
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php else : ?>
                                            <div style="width: 100%; height: 400px; margin: auto; text-align: center; display: flex; align-items: center; justify-content: center;">
                        ...
                        <div class="card shadow" style="margin: 2.5%;">
                            ...
                            <div class="card-body">
                                <div class="table-responsive table mt-2" role="grid" aria-describedby="dataTable_info">
                                    <table class="table my-0 table-responsive table mt-2 order-column hover" id="dataTableadjust">
                                        <thead>
                                            <tr>
