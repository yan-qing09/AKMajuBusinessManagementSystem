...
$query = "SELECT DO_path, O_id 
          FROM tb_delivery_order
          WHERE DO_id = '$doId'";
$result = mysqli_query($con, $query);

    if ($result && $row = mysqli_fetch_assoc($result)) {
        $attachmentPath = 'C:/xampp/htdocs/AKMaju/AKMaju/' . $row['DO_path'];
    ...
    $mail->Subject = "Delivery Order";   // email subject headings
...
header("Location: EditAOrder.php?id=$fid&o_id=$do");
