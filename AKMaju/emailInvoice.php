...
$query = "SELECT I_path, O_id 
          FROM tb_invoice 
          WHERE I_id = '$iId'";
$result = mysqli_query($con, $query);

    if ($result && $row = mysqli_fetch_assoc($result)) {
        $attachmentPath = 'C:/xampp/htdocs/AKMaju/AKMaju/' . $row['I_path'];
    ...
    $mail->Subject = "Invoice";   // email subject headings
...
header("Location: EditAOrder.php?id=$fid&o_id=$invoice");
