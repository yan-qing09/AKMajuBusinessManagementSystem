            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-4">Add Kejuteraan Awam Order Material</h3>
                    </div>   
                    <div class="card shadow mb-3">
                        ...
                        <div class="card-body">
                            <?php
                                echo "<form method='get' onsubmit='return validateForm()' action='save_AKaddorder.php?id=".$rows['U_id']."&co_id=$co_id'>";
                            ?>
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                    ...
                    <?php
                        echo "<div class='mb-3'><a href='save_CAddorder.php?id=" . $rows['U_id'] . "&co_id=" . $co_id . "'><button class='btn btn-primary btn-sm'>Order Summary ></button></a></div>";
                    ?>
                </div>                
            </div>
