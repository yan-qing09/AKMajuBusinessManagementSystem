                ...
                <div class="col-md-6 col-xl-4 ">
                    <div class="card mb-5" style=" box-shadow: 0px 7px 29px 0px rgba(100, 100, 111, 0.8);background: linear-gradient(265deg, rgba(230,0,0,1) 0%, rgba(144,0,0,1) 30%, rgba(24,0,0,1) 100%);  ">
                        <div class="card-body d-flex flex-column align-items-center">
                            ...
                            <h4 style="color:white;margin-top:-10px;margin-bottom:15px;font-weight:bold;">Oops !</h4>
                            <p style="color: rgba(255, 255, 255, 0.8);font-size:15px;text-align:center;">Something went wrong while sending the email. Please try again later. If the issue persists, contact support.</p>
                                    <a type="button" href="forgotpassword.php"class="btn btn-light d-block w-100" type="submit">Forgot Password</a>
