...
$sql = "SELECT *
        FROM tb_customer
        LEFT JOIN tb_construction_order ON tb_customer.C_id = tb_construction_order.C_id
        LEFT JOIN tb_customer_phone ON tb_customer.C_id = tb_customer_phone.C_id
        WHERE tb_construction_order.O_status = 2";
...
$sql5 = "SELECT *
        ...
        LEFT JOIN tb_construction_order ON tb_customer.C_id = tb_construction_order.C_id
        LEFT JOIN tb_customer_phone ON tb_customer.C_id = tb_customer_phone.C_id
        WHERE tb_construction_order.O_status = 3";
...
$sql6 = "SELECT *
        ...
        LEFT JOIN tb_construction_order ON tb_customer.C_id = tb_construction_order.C_id
        LEFT JOIN tb_customer_phone ON tb_customer.C_id = tb_customer_phone.C_id
        WHERE tb_construction_order.O_status = 1";
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-4">Construction Order</h3>
                        <?php 
                            echo"<a href='AddCOrder.php?id=".$rows['U_id']."' class='btn btn-primary' role='button' style='text-align: center;'>";
                                ...
                                <table class="table my-0 table-responsive table mt-2" id="dataTable2">
                                    ...
                                    <tbody>
                                        ...
                                        while($row = mysqli_fetch_array($result)) {
                                            echo "<tr>";
                                                echo "<td class='co_id'>".$row['O_id']."</td>";
                                                ...
                                                echo "<td>";
                                                    echo "<span>";
                                                        echo "<div>";
                                                            ...
                                                            echo"<a href='EditCOrder.php?id=".$rows['U_id']."&co_id=".$row['O_id']."' class='btn btn-primary m-1' role='button'>";
                                                            echo"<i class='fas fa-pen'></i>";
                                                            echo"</a>";

                                                            echo "<button class='btn btn-danger m-1 delete-btn' type='button' data-bs-toggle='modal' data-bs-target='#modal-1' data-co-id='".$row['O_id']."'>";
                                            ...
                                            echo "<div class='modal fade' role='dialog' tabindex='-1' id='modal-1' style='margin: 0px; margin-top: 0px; text-align: left;'>
                                                    <div class='modal-dialog modal-dialog-centered' role='document'>
                                                        <div class='modal-content'>
                                                            ...
                                                            <div class='modal-footer'>
                                                                ...
                                                                <a href='deleteCorder.php?id=" . $rows['U_id'] . "&co_id=" . $row['O_id'] . "' class='btn btn-danger' style='background: rgb(205,10,10);'>Delete</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>";
                                                ...
                                                <div class='modal-dialog modal-dialog-centered' role='document'>
                                                    <div class='modal-content'>
                                                        ...
                                                        <div class='modal-footer'>
                                                            <button class='btn btn-light' type='button' data-bs-dismiss='modal'>Cancel</button>
                                                            <a href='completeCorder.php?id=" . $rows['U_id'] . "&o_id=" . $row['O_id'] . "' class='btn btn-danger' style='background: rgb(205,10,10);'>Comfirm</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>";
                                ...
                                <table class="table my-0 table-responsive table mt-2" id="dataTable3">
                                    ...
                                    <tbody>
                                        ...
                                        while($row5 = mysqli_fetch_array($result5)) {
                                            echo "<tr>";
                                                echo "<td class='co_id'>".$row5['O_id']."</td>";
                                                ...
                                                echo "<td>";
                                                    echo "<span>";
                                                        echo "<div>";
                                                            echo "<a href='COrderDetails.php?id=".$rows['U_id']."&co_id=".$row5['O_id']."' class='btn btn-primary m-1' role='button'>";
                                ...
                                <table class="table my-0 table-responsive table mt-2" id="dataTable4">
                                    ...
                                    <tbody>
                                        ...
                                        while($row6 = mysqli_fetch_array($result6)) {
                                            echo "<tr>";
                                                echo "<td class='co_id'>".$row6['O_id']."</td>";
                                                ...
                                                echo "<td>";
                                                    echo "<span>";
                                                        echo "<div>";
                                                            echo "<a href='COrderDetails.php?id=".$rows['U_id']."&co_id=".$row6['O_id']."' class='btn btn-primary m-1' role='button'>";
                                                            echo"<i class='fas fa-book-open'></i>";
                                                            echo"</a>";
                                                        echo "</div>";
                                                    echo "</span>";
 ...
 <script>
    ...
    deleteButtons.forEach(button => {
        button.addEventListener('click', () => {
            const coId = button.getAttribute('data-co-id');
            ...
            const rowCOId = row.querySelector('.co_id').innerText.trim();
            
            // Set the correct AO_id for deletion
            modalDeleteButton.setAttribute('href', `deleteCorder.php?id=<?php echo $rows['U_id']; ?>&co_id=${rowCOId}`);
            
            // Update the modal title with the specific AO_id (if necessary)
            const modalTitle = document.querySelector('#modal-1 .modal-title');
            modalTitle.innerHTML = `${rowCOId} Delete Order`;
        });
    });
</script>
</body>
