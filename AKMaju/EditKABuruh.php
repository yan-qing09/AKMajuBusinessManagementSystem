            ...
            <div id="content">
                ...
                <div class="container-fluid">
                        <div class="d-sm-flex justify-content-between align-items-center mb-4">
                            <h3 class="text-dark mb-4">Edit Kadar Awam</h3>
                        </div>
                        <?php
                        echo "<div class='mb-3'>
                        <a href='EditCOrder.php?id=" . $rows['U_id'] . "&co_id=" . $co_id . "'><button class='btn btn-primary btn-sm' type='button'>Order Details</button></a>
                        <a href='EditCEOrdermaterial.php?id=" . $rows['U_id'] . "&co_id=" . $co_id . "'><button class='btn btn-primary btn-sm' type='button'>Electric Order Material</button></a>
                        <a href='EditKAOrdermaterial.php?id=" . $rows['U_id'] . "&co_id=" . $co_id . "'><button class='btn btn-primary btn-sm' type='button'>Kejuteraan Awam Order Material</button></a>
                        <a href='save_CEditorder.php?id=" . $rows['U_id'] . "&co_id=" . $co_id . "'><button class='btn btn-primary btn-sm' type='button'>Order Summary</button></a>
                        </div>";
                    ?>
                    <?php
                        echo "<form method='get' onsubmit='return validateForm()' action='save_EditBuruh.php?id=".$rows['U_id']."&co_id=$co_id'>"
                    ?>
                        <div id="addOrderMaterialCard1" class="card shadow mb-3">
                    ...
                    <?php
                        echo "<form method='get' onsubmit='return validateForm()' action='save_EditLogi.php?id=".$rows['U_id']."&co_id=$co_id'>"
                    ?>
                        <div id="addOrderMaterialCard2" class="card shadow mb-3">
                            <div class="card-header py-3">
                    ...
                    <div class="card shadow mb-3">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-end align-items-center">
                                <form id="addOrderMaterialForm1" action="#addOrderMaterialCard1">
                                    <button class="btn btn-primary btn-sm" type="submit">Add Kadar Upah Buruh</button>
                                </form>
                                <script>
                                    document.getElementById('addOrderMaterialForm1').addEventListener('submit', function (event) {
                                        event.preventDefault();
                                        var addOrderMaterialCard1 = document.getElementById('addOrderMaterialCard1');
                                        addOrderMaterialCard1.scrollIntoView({ behavior: 'smooth' });
                                    });
                                </script>
                                <form id="addOrderMaterialForm2" action="#addOrderMaterialCard2">
                                    <button class="btn btn-primary btn-sm" type="submit">Add Kadar Sewa Logi</button>
                                </form>
                                <script>
                                    document.getElementById('addOrderMaterialForm2').addEventListener('submit', function (event) {
                                        event.preventDefault();
                                        var addOrderMaterialCard2 = document.getElementById('addOrderMaterialCard2');
                                        addOrderMaterialCard2.scrollIntoView({ behavior: 'smooth' });
                                    });
                                </script>
                            </div>
                    ...
                    <?php
                        echo "<div class='mb-3'>
                        <a href='EditCEOrdermaterial.php?id=" . $rows['U_id'] . "&co_id=" . $co_id . "'><button class='btn btn-primary btn-sm'>< Back</button></a>
...
$(document).ready(function() {
    $('.deleteMaterial').on('click', function() {
        ...
        $.ajax({
            type: 'POST',
            url: 'delete_EditABuruh.php', // Change to your PHP file handling deletion
            data: {
                    CO_id: coid,
                    AK_name: akname,
                    AK_region: akregion,
